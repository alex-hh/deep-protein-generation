...
class MSAVAE(BaseProtVAE):
  def __init__(self, latent_dim=10, original_dim=360,
      ...
      super().__init__(latent_dim=latent_dim, original_dim=original_dim, n_conditions=n_conditions, autoregressive=False)
...
class ARVAE(BaseProtVAE):
  def __init__(self, upsample=False, original_dim=504, latent_dim=50,
    ...
    super().__init__(latent_dim=latent_dim, original_dim=original_dim, autoregressive=True, clipnorm=clipnorm, lr=lr)
